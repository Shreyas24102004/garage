            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                       ...
                       <!--  <li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted  " href="dashboard.php"><i class="mdi mdi-menu"></i></a> </li>
                        <li class="nav-item m-l-10"> <a class="nav-link sidebartoggler hidden-sm-down text-muted  " href="dashboard.php"><i class="ti-menu"></i></a> </li> -->
